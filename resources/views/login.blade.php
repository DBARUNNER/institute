...
<!-- Mirrored from www.tattek.sk/minovate-noAngular/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2016 20:08:53 GMT -->
<head>
                ...
                <div class="container w-420 p-15 bg-white mt-40 text-center">
                    ...
                    <form name="form" class="form-validation mt-20" novalidate="">
                        ...
                        <div class="form-group text-left mt-20">
                            <a href="{{ URL::to('home') }}" class="btn btn-greensea b-0 br-2 mr-5">Login</a>
