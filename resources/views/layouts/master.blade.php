...
<!-- Mirrored from www.tattek.sk/minovate-noAngular/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2016 20:05:57 GMT -->
<head>
                    ...
                    <ul class="nav-right pull-right list-inline">
                        ...
                        <li class="dropdown nav-profile">
                            ...
                            <a href class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>حیب الله <i class="fa fa-angle-down"></i></span>
                            </a>
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-users"></i> <span>کانکور</span></a>
                                                <ul>
                                                    <li><a href="mail-inbox.html"><i class="fa fa-caret-right"></i>ثبت نام شاگردان</a></li>
                                                    <li><a href="mail-compose.html"><i class="fa fa-caret-right"></i>وارید نمودن نمرات</a></li>
                                                    <li><a href="mail-compose.html"><i class="fa fa-caret-right"></i>لیست کانکور</a></li>
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-bed"></i> <span>اطاق ها</span></a>
                                                <ul>
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-bar-chart"></i> <span>مدیریت مالی</span> </a>
                                                <ul>
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-table"></i> <span>مدیریت منابع</span></a>
                                                <ul>
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-desktop"></i> <span>لابراتوار</span></a>
                                                <ul>
                                            ...
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-clock-o"></i> <span>مدیریت تایم</span></a>
                                                <ul>
											 ...
											 <li>
                                                <a role="button" tabindex="0"><i class="fa fa-clock-o"></i> <span>تراسپورت</span></a>
                                                <ul>
                                                    <li><a href="layout-boxed.html"><i class="fa fa-caret-right"></i> Boxed layout</a></li>
                                                    <li><a href="layout-fullwidth.html"><i class="fa fa-caret-right"></i> Full-width layout</a></li>
                                                    <li><a href="layout-sidebar-sm.html"><i class="fa fa-caret-right"></i> Small sidebar</a></li>
                                            ...
                                            <!--</li>-->
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-file"></i> <span>راپورها</span></a>
                                                <ul>
                                                    <li><a href="maps-vector.html"><i class="fa fa-caret-right"></i> نقشه ویکتوری</a></li>
                                                    <li><a href="maps-google.html"><i class="fa fa-caret-right"></i> نقشه گوگل</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="calendar.html"><i class="fa fa-calendar-o"></i> <span>دواخانه</span> </a></li>
                                            <li><a href="charts.html"><i class="fa fa-user"></i> <span>مدیریت کاربران</span></a></li>

                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-cog"></i> <span>تنظیمات</span></a>
                                                <ul>
                                                    <li>
