...
@section('content')
	<div class="page page-dashboard" style="overflow:hidden">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>داشبورد <span>بخش مدیریت وکنترول اپلیکیشن</span></h2>
                            ...
                            <div class="card">
                                <div class="front bg-greensea">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0">3 09</p>
                                            <span>مریضان تداوی شده</span>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                                ...
                                <div class="back bg-greensea">
                                    ...
                                    <div class="row">
                                        <!-- col -->
                                        <div class="col-xs-4">
                                            <a href="#"><i class="fa fa-cog fa-2x"></i> تنظیمات</a>
                                        </div>
                                        <!-- /col -->
                                        <!-- col -->
                                        <div class="col-xs-4">
                                            <a href="#"><i class="fa fa-chain-broken fa-2x"></i> تماس</a>
                                        </div>
                                        <!-- /col -->
                                        <!-- col -->
                                        <div class="col-xs-4">
                                            <a href="#"><i class="fa fa-ellipsis-h fa-2x"></i> بیشتر</a>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                            ...
                            <div class="card">
                                <div class="front bg-lightred">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0">9 4</p>
                                            <span>مریضان تحت تداوی</span>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                            ...
                            <div class="card">
                                <div class="front bg-blue">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0">1 4</p>
                                            <span>تعداد داکتران مصروف</span>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                            ...
                            <div class="card">
                                <div class="front bg-slategray">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"> 5</p>
                                            <span>تعداد داکتران فری</span>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                        ...
                        <div class="col-md-8">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header bg-greensea dvd dvd-btm">
                                    <h1 class="custom-font"><strong>گراف احصاییوی </strong>مراجعین</h1>
                                    <ul class="controls">
                                        <li>
                                            <a role="button" tabindex="0" class="pickDate">
                                                <span>April 6, 2016 - May 5, 2016</span>&nbsp;&nbsp;<i class="fa fa-angle-down"></i>
                                            </a>
                                        </li>
                                        <li class="dropdown">
                                ...
                                <div class="tile-widget bg-greensea">
                                    <div id="statistics-chart" style="height: 250px; padding: 0px; position: relative;"><canvas height="250" width="608" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 608px; height: 250px;" class="flot-base"></canvas><div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);" class="flot-text"><div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;" class="flot-x-axis flot-x1-axis xAxis x1Axis"><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 29px; text-align: center;">JAN</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 78px; text-align: center;">FEB</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 123px; text-align: center;">MAR</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 173px; text-align: center;">APR</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 220px; text-align: center;">MAY</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 269px; text-align: center;">JUN</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 318px; text-align: center;">JUL</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 364px; text-align: center;">AUG</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 414px; text-align: center;">SEP</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 460px; text-align: center;">OCT</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 507px; text-align: center;">NOV</div><div style="position: absolute; max-width: 50px; top: 236px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 556px; text-align: center;">DEC</div></div><div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;" class="flot-y-axis flot-y1-axis yAxis y1Axis"><div style="position: absolute; top: 210px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 13px; text-align: right;">0</div><div style="position: absolute; top: 157px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 7px; text-align: right;">50</div><div style="position: absolute; top: 105px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 1px; text-align: right;">100</div><div style="position: absolute; top: 53px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 1px; text-align: right;">150</div><div style="position: absolute; top: 1px; font: 400 11px/13px &quot;Lato&quot;,&quot;Arial&quot;,sans-serif; color: rgb(255, 255, 255); left: 1px; text-align: right;">200</div></div></div><canvas height="250" width="608" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 608px; height: 250px;" class="flot-overlay"></canvas><div class="legend"><table style="position:absolute;top:0px;right:5px;;font-size:smaller;color:#545454"><tbody><tr><td class="legendColorBox"><div style="border:1px solid #ccc;padding:1px"><div style="width:4px;height:0;border:5px solid rgb(224,93,111);overflow:hidden"></div></div></td><td class="legendLabel">ولایات کشور</td><td class="legendColorBox"><div style="border:1px solid #ccc;padding:1px"><div style="width:4px;height:0;border:5px solid rgb(97,200,184);overflow:hidden"></div></div></td><td class="legendLabel">مرکز شهر</td></tr></tbody></table></div></div>
                                </div>
                                <!-- /tile widget -->
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile" fullscreen="isFullscreen02">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>داکتران درهردیپارتمنت </strong></h1>
                                    <ul class="controls">
                                        <li class="dropdown">
                                ...
                                <div class="tile-widget">
                                    <div id="browser-usage" style="height: 250px"><svg style="overflow: hidden; position: relative; top: -0.200012px;" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" width="274" version="1.1" height="250"><desc>Created with Raphaël 2.1.2</desc><defs></defs><path opacity="0" stroke-width="2" d="M137,201.66666666666669A76.66666666666667,76.66666666666667,0,0,0,213.62571285773922,127.50557514776123" stroke="#00a3d8" fill="none" style="opacity: 0;"></path><path stroke-width="3" d="M137,204.66666666666669A79.66666666666667,79.66666666666667,0,0,0,216.62411031738986,127.60361939267362L246.94124018719106,128.59495564678787A110,110,0,0,1,137,235Z" stroke="#ffffff" fill="#00a3d8" style=""></path><path opacity="1" stroke-width="2" d="M213.62571285773922,127.50557514776123A76.66666666666667,76.66666666666667,0,0,0,164.00430527411916,53.24663579705856" stroke="#2fbbe8" fill="none" style="opacity: 1;"></path><path stroke-width="3" d="M216.62411031738986,127.60361939267362A79.66666666666667,79.66666666666667,0,0,0,165.06099548049775,50.43889545868258L177.50645791117876,17.36995369558784A115,115,0,0,1,251.9385692866088,128.75836272164184Z" stroke="#ffffff" fill="#2fbbe8" style=""></path><path opacity="0" stroke-width="2" d="M164.00430527411916,53.24663579705856A76.66666666666667,76.66666666666667,0,0,0,94.4094071538928,61.251908430174154" stroke="#72cae7" fill="none" style="opacity: 0;"></path><path stroke-width="3" d="M165.06099548049775,50.43889545868258A79.66666666666667,79.66666666666667,0,0,0,92.74281873817557,58.757417890485314L75.89175809036794,33.53534687807597A110,110,0,0,1,175.74530756721444,22.049520926214456Z" stroke="#ffffff" fill="#72cae7" style=""></path><path opacity="0" stroke-width="2" d="M94.4094071538928,61.251908430174154A76.66666666666667,76.66666666666667,0,0,0,74.69191290140762,80.32920350058663" stroke="#d9544f" fill="none" style="opacity: 0;"></path><path stroke-width="3" d="M92.74281873817557,58.757417890485314A79.66666666666667,79.66666666666667,0,0,0,72.25377036276704,78.58121581147914L47.60144024984571,60.90711806605907A110,110,0,0,1,75.89175809036794,33.53534687807597Z" stroke="#ffffff" fill="#d9544f" style=""></path><path opacity="0" stroke-width="2" d="M74.69191290140762,80.32920350058663A76.66666666666667,76.66666666666667,0,0,0,60.373503773953345,127.48150234685303" stroke="#ffc100" fill="none" style="opacity: 0;"></path><path stroke-width="3" d="M72.25377036276704,78.58121581147914A79.66666666666667,79.66666666666667,0,0,0,57.37507566076022,127.57860461259945L27.057635849585253,128.56041641070217A110,110,0,0,1,47.60144024984571,60.90711806605907Z" stroke="#ffffff" fill="#ffc100" style=""></path><path opacity="0" stroke-width="2" d="M60.373503773953345,127.48150234685303A76.66666666666667,76.66666666666667,0,0,0,136.9759144567186,201.66666288331834" stroke="#1693a5" fill="none" style="opacity: 0;"></path><path stroke-width="3" d="M57.37507566076022,127.57860461259945A79.66666666666667,79.66666666666667,0,0,0,136.97497197893804,204.6666627352743L136.9654424813789,234.99999457171762A110,110,0,0,1,27.057635849585253,128.56041641070217Z" stroke="#ffffff" fill="#1693a5" style=""></path><text stroke-width="0.4695652173913043" transform="matrix(2.1296,0,0,2.1296,-155.3241,-140.0741)" font-weight="800" fill="#000000" stroke="none" font-size="15px" font-family="&quot;Arial&quot;" text-anchor="middle" y="115" x="137" style="text-anchor: middle; font-family: &quot;Arial&quot;; font-size: 15px; font-weight: 800;"><tspan dy="5">چشم</tspan></text><text stroke-width="0.6260869565217391" transform="matrix(1.5972,0,0,1.5972,-82.4167,-75.8472)" fill="#000000" stroke="none" font-size="14px" font-family="&quot;Arial&quot;" text-anchor="middle" y="135" x="137" style="text-anchor: middle; font-family: &quot;Arial&quot;; font-size: 14px;"><tspan dy="5">20</tspan></text></svg></div>
                                </div>
                                <!-- /tile widget -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile tile-simple bg-lightred" style="min-height: 190px; overflow: hidden;">
                                ...
                                <div class="tile-body">
                                    ...
                                    <div style="opacity: 1; display: block;" id="todo-carousel" class="owl-carousel owl-theme">

                                        <div class="owl-wrapper-outer"><div style="width: 1644px; left: 0px; display: block; transition: all 400ms ease 0s; transform: translate3d(-274px, 0px, 0px);" class="owl-wrapper"><div style="width: 274px;" class="owl-item"><div>
                                            <div class="progress-list">
                                                <div class="details">
                                        ...
                                        </div></div><div style="width: 274px;" class="owl-item"><div>
                                            <div class="progress-list">
                                                <div class="details">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body p-0" style="height: 133px">
                                    ...
                                    <div class="rickshaw rickshaw_graph" id="realtime-rickshaw"><svg height="133" width="304"><g><path fill="lightblue" class="area" d="M0,8.193507693453512Q5.3768707482993205,12.707028553940802,6.204081632653062,13.506868147170337C7.444897959183674,14.706627537014642,11.16734693877551,19.677824116638543,12.408163265306124,20.191101591896555S17.371428571428574,18.14315227004906,18.612244897959187,18.63964289975044S23.575510204081635,26.03648704126927,24.816326530612248,25.156007888910352S29.779591836734696,11.889712809994332,31.02040816326531,9.834851376161254S35.98367346938776,3.5711667159189378,37.22448979591837,4.607393550579559S42.18775510204081,19.47858748121909,43.42857142857142,20.197119722767468S48.39183673469388,12.66834131658573,49.632653061224495,11.79271596606334S54.59591836734694,10.836131678405433,55.83673469387755,11.440866217543572S60.800
591836,133,279.18367346938777,133S274.2204081632653,133,272.9795918367347,133S268.0163265306123,133,266.7755102040817,133S261.8122448979592,133,260.5714285714286,133S255.60816326530613,133,254.3673469387755,133S249.4040816326531,133,248.16326530612247,133S243.20000000000002,133,241.9591836734694,133S236.99591836734697,133,235.75510204081635,133S230.7918367346939,133,229.55102040816328,133S224.58775510204083,133,223.3469387755102,133S218.38367346938776,133,217.14285714285714,133S212.1795918367347,133,210.93877551020407,133S205.97551020408164,133,204.73469387755102,133S199.7714285714286,133,198.53061224489798,133S193.56734693877553,133,192.3265306122449,133S187.36326530612246,133,186.12244897959184,133S181.15918367346939,133,179.91836734693877,133S174.9551020408163,133,173.7142857142857,133S168.7510204081633,133,167.51020408163268,133S162.54693877551023,133,161.3061224489796,133S156.34285714285716,133,155.10204081632654,133S150.1387755102041,133,148.8979591836735,133S143.93469387755104,133,142.69387755102042,133S137.73061224489797,133,136.48979591836735,133S131.52653061224493,133,130.2857142857143,133S125.32244897959184,133,124.08163265306123,133S119.11836734693878,133,117.87755102040818,133S112.91428571428573,133,111.6734693877551,133S106.71020408163264,133,105.46938775510203,133S100.5061224489796,133,99.26530612244899,133S94.30204081632654,133,93.06122448979592,133S88.09795918367345,133,86.85714285714285,133S81.89387755102041,133,80.6530612244898,133S75.68979591836735,133,74.44897959183675,133S69.48571428571428,133,68.24489795918367,133S63.28163265306123,133,62.04081632653062,133S57.077551020408166,133,55.83673469387755,133S50.87346938775511,133,49.632653061224495,133S44.669387755102036,133,43.42857142857142,133S38.465306122448986,133,37.22448979591837,133S32.26122448979592,133,31.02040816326531,133S26.05714285714286,133,24.816326530612248,133S19.8530612244898,133,18.612244897959187,133S13.648979591836737,133,12.408163265306124,133S7.444897959183674,133,6.204081632653062,133Q5.3768707482993205,133,0,133Z"></path></g></svg><div class="detail"></div></div>
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile tile-simple bg-blue" style="min-height: 190px; overflow: hidden;">
                                ...
                                <div class="tile-body">
                                    ...
                                    <div style="opacity: 1; display: block;" id="feed-carousel" class="owl-carousel owl-theme">

                                        <div class="owl-wrapper-outer"><div style="width: 1644px; left: 0px; display: block; transition: all 400ms ease 0s; transform: translate3d(-274px, 0px, 0px);" class="owl-wrapper"><div style="width: 274px;" class="owl-item"><div class="media social-feed">
                                        ...
                                        </div></div><div style="width: 274px;" class="owl-item"><div class="media social-feed">
                                            <span class="pull-left">
                                ...
                                <div class="tile-body lined-paper">
                                    ...
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="col-sm-10">
                                                <input class="form-control input-unstyled" id="todo" placeholder="type todo here..." required="" type="text">
                                            </div>
                                            <div class="col-sm-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile tile-simple" style="min-height: 190px; overflow: hidden;">
                                ...
                                <!-- tile body -->
                                <div class="tile-body lined-paper">
                                    <div style="opacity: 1; display: block;" id="notes-carousel" class="owl-carousel owl-theme">

                                        <div class="owl-wrapper-outer"><div style="width: 1284px; left: 0px; display: block; transition: all 400ms ease 0s; transform: translate3d(-214px, 0px, 0px);" class="owl-wrapper"><div style="width: 214px;" class="owl-item"><div>
                                        ...
                                        </div></div><div style="width: 214px;" class="owl-item"><div>
                            ...
                            <section class="tile bg-slategray widget-calendar">
                                ...
                                <!-- tile body -->
                                <div class="tile-body p-0">
                                    <div id="mini-calendar"><div style="display: block;" class="bootstrap-datetimepicker-widget"><ul class="list-unstyled"><li class="collapse in"><div class="datepicker"><div style="display: block;" class="datepicker-days"><table class="table-condensed"><thead><tr><th data-action="previous" class="prev"><span class="glyphicon glyphicon-chevron-left"></span></th><th colspan="5" data-action="pickerSwitch" class="picker-switch">May 2016</th><th data-action="next" class="next"><span class="glyphicon glyphicon-chevron-right"></span></th></tr><tr><th class="dow">Su</th><th class="dow">Mo</th><th class="dow">Tu</th><th class="dow">We</th><th class="dow">Th</th><th class="dow">Fr</th><th class="dow">Sa</th></tr></thead><tbody><tr><td data-action="selectDay" class="day weekend">1</td><td data-action="selectDay" class="day">2</td><td data-action="selectDay" class="day">3</td><td data-action="selectDay" class="day">4</td><td data-action="selectDay" class="day active today">5</td><td data-action="selectDay" class="day">6</td><td data-action="selectDay" class="day weekend">7</td></tr><tr><td data-action="selectDay" class="day weekend">8</td><td data-action="selectDay" class="day">9</td><td data-action="selectDay" class="day">10</td><td data-action="selectDay" class="day">11</td><td data-action="selectDay" class="day">12</td><td data-action="selectDay" class="day">13</td><td data-action="selectDay" class="day weekend">14</td></tr><tr><td data-action="selectDay" class="day weekend">15</td><td data-action="selectDay" class="day">16</td><td data-action="selectDay" class="day">17</td><td data-action="selectDay" class="day">18</td><td data-action="selectDay" class="day">19</td><td data-action="selectDay" class="day">20</td><td data-action="selectDay" class="day weekend">21</td></tr><tr><td data-action="selectDay" class="day weekend">22</td><td data-action="selectDay" class="day">23</td><td data-action="selectDay" class="day">24</td><td data-action="selectDay" class="day">25</td><td data-action="selectDay" class="day">26</td><td data-action="selectDay" class="day">27</td><td data-action="selectDay" class="day weekend">28</td></tr><tr><td data-action="selectDay" class="day weekend">29</td><td data-action="selectDay" class="day">30</td><td data-action="selectDay" class="day">31</td><td data-action="selectDay" class="day new">1</td><td data-action="selectDay" class="day new">2</td><td data-action="selectDay" class="day new">3</td><td data-action="selectDay" class="day new weekend">4</td></tr></tbody></table></div><div style="display: none;" class="datepicker-months"><table class="table-condensed"><thead><tr><th data-action="previous" class="prev"><span class="glyphicon glyphicon-chevron-left"></span></th><th colspan="5" data-action="pickerSwitch" class="picker-switch">2016</th><th data-action="next" class="next"><span class="glyphicon glyphicon-chevron-right"></span></th></tr></thead><tbody><tr><td colspan="7"><span class="month" data-action="selectMonth">Jan</span><span class="month" data-action="selectMonth">Feb</span><span class="month" data-action="selectMonth">Mar</span><span class="month" data-action="selectMonth">Apr</span><span class="month active" data-action="selectMonth">May</span><span class="month" data-action="selectMonth">Jun</span><span class="month" data-action="selectMonth">Jul</span><span class="month" data-action="selectMonth">Aug</span><span class="month" data-action="selectMonth">Sep</span><span class="month" data-action="selectMonth">Oct</span><span class="month" data-action="selectMonth">Nov</span><span class="month" data-action="selectMonth">Dec</span></td></tr></tbody></table></div><div style="display: none;" class="datepicker-years"><table class="table-condensed"><thead><tr><th data-action="previous" class="prev"><span class="glyphicon glyphicon-chevron-left"></span></th><th colspan="5" data-action="pickerSwitch" class="picker-switch">2011-2022</th><th data-action="next" class="next"><span class="glyphicon glyphicon-chevron-right"></span></th></tr></thead><tbody><tr><td colspan="7"><span data-action="selectYear" class="year">2011</span><span data-action="selectYear" class="year">2012</span><span data-action="selectYear" class="year">2013</span><span data-action="selectYear" class="year">2014</span><span data-action="selectYear" class="year">2015</span><span data-action="selectYear" class="year active">2016</span><span data-action="selectYear" class="year">2017</span><span data-action="selectYear" class="year">2018</span><span data-action="selectYear" class="year">2019</span><span data-action="selectYear" class="year">2020</span><span data-action="selectYear" class="year">2021</span><span data-action="selectYear" class="year">2022</span></td></tr></tbody></table></div></div></li><li class="picker-switch accordion-toggle"><table class="table-condensed"><tbody><tr><td><a data-action="togglePicker"><span class="glyphicon glyphicon-time"></span></a></td></tr></tbody></table></li><li class="collapse"><div class="timepicker"><div class="timepicker-picker"><table class="table-condensed"><tbody><tr><td><a data-action="incrementHours" class="btn" tabindex="-1" href="#"><span class="glyphicon glyphicon-chevron-up"></span></a></td><td class="separator"></td><td><a data-action="incrementMinutes" class="btn" tabindex="-1" href="#"><span class="glyphicon glyphicon-chevron-up"></span></a></td><td class="separator"></td></tr><tr><td><span data-action="showHours" data-time-component="hours" class="timepicker-hour">01</span></td><td class="separator">:</td><td><span data-action="showMinutes" data-time-component="minutes" class="timepicker-minute">31</span></td><td><button data-action="togglePeriod" class="btn btn-primary">PM</button></td></tr><tr><td><a data-action="decrementHours" class="btn" tabindex="-1" href="#"><span class="glyphicon glyphicon-chevron-down"></span></a></td><td class="separator"></td><td><a data-action="decrementMinutes" class="btn" tabindex="-1" href="#"><span class="glyphicon glyphicon-chevron-down"></span></a></td><td class="separator"></td></tr></tbody></table></div><div style="display: none;" class="timepicker-hours"><table class="table-condensed"><tbody><tr><td data-action="selectHour" class="hour">12</td><td data-action="selectHour" class="hour">01</td><td data-action="selectHour" class="hour">02</td><td data-action="selectHour" class="hour">03</td></tr><tr><td data-action="selectHour" class="hour">04</td><td data-action="selectHour" class="hour">05</td><td data-action="selectHour" class="hour">06</td><td data-action="selectHour" class="hour">07</td></tr><tr><td data-action="selectHour" class="hour">08</td><td data-action="selectHour" class="hour">09</td><td data-action="selectHour" class="hour">10</td><td data-action="selectHour" class="hour">11</td></tr></tbody></table></div><div style="display: none;" class="timepicker-minutes"><table class="table-condensed"><tbody><tr><td data-action="selectMinute" class="minute">00</td><td data-action="selectMinute" class="minute">05</td><td data-action="selectMinute" class="minute">10</td><td data-action="selectMinute" class="minute">15</td></tr><tr><td data-action="selectMinute" class="minute">20</td><td data-action="selectMinute" class="minute">25</td><td data-action="selectMinute" class="minute">30</td><td data-action="selectMinute" class="minute">35</td></tr><tr><td data-action="selectMinute" class="minute">40</td><td data-action="selectMinute" class="minute">45</td><td data-action="selectMinute" class="minute">50</td><td data-action="selectMinute" class="minute">55</td></tr></tbody></table></div></div></li></ul></div></div>
                                </div>
                                <!-- /tile body -->
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body table-custom">
                                    ...
                                    <div class="table-responsive">
                                        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="project-progress_wrapper"><div class="row"><div class="col-sm-6"><div id="project-progress_length" class="dataTables_length"><label>Show <select class="form-control input-sm" aria-controls="project-progress" name="project-progress_length"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-6"><div class="dataTables_filter" id="project-progress_filter"><label>Search:<input aria-controls="project-progress" placeholder="" class="form-control input-sm" type="search"></label></div></div></div><div class="row"><div class="col-sm-12"><table aria-describedby="project-progress_info" role="grid" class="table table-custom dataTable no-footer" id="project-progress">
                                            <thead>
                                            <tr role="row"><th aria-label="ID: activate to sort column descending" aria-sort="ascending" style="width: 16px;" colspan="1" rowspan="1" aria-controls="project-progress" tabindex="0" class="sorting_asc">ID</th><th aria-label="Project: activate to sort column ascending" style="width: 165px;" colspan="1" rowspan="1" aria-controls="project-progress" tabindex="0" class="sorting">Project</th><th aria-label="Priority: activate to sort column ascending" style="width: 88px;" colspan="1" rowspan="1" aria-controls="project-progress" tabindex="0" class="sorting">Priority</th><th aria-label="Status: activate to sort column ascending" colspan="1" rowspan="1" aria-controls="project-progress" tabindex="0" class="sorting" style="width: 200px;">Status</th><th aria-label="Chart" colspan="1" rowspan="1" style="width: 60px;" class="text-right no-sort sorting_disabled">Chart</th></tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            <tr class="odd" role="row">
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="1,3,2,3,5,6,8,5,9,8" sparktype="bar" sparkbarcolor="#cd97eb" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="2,5,3,4,6,5,1,8,9,10" sparktype="bar" sparkbarcolor="#a2d200" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="5,6,8,2,1,6,8,4,3,5" sparktype="bar" sparkbarcolor="#ffc100" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                            </tr><tr class="even" role="row">
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="2,9,8,7,5,9,2,3,4,2" sparktype="bar" sparkbarcolor="#16a085" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                            </tr><tr class="odd" role="row">
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="3,5,6,2,8,9,5,4,3,2" sparktype="bar" sparkbarcolor="#1693A5" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                            </tr><tr class="even" role="row">
                                                ...
                                                <td class="text-right">
                                                    <span class="sparklineChart" values="7,8,6,4,3,5,8,9,10,7" sparktype="bar" sparkbarcolor="#3f4e62" sparkbarwidth="4px" sparkheight="18px"><canvas height="18" width="49" style="display: inline-block; width: 49px; height: 18px; vertical-align: top;"></canvas></span>
                                                </td>
                                            </tr></tbody>
                                        </table></div></div><div class="row"><div class="col-sm-5"><div aria-live="polite" role="status" id="project-progress_info" class="dataTables_info">Showing 1 to 6 of 6 entries</div></div><div class="col-sm-7"><div id="project-progress_paginate" class="dataTables_paginate paging_simple_numbers"><ul class="pagination"><li id="project-progress_previous" class="paginate_button previous disabled"><a tabindex="0" data-dt-idx="0" aria-controls="project-progress" href="#">Previous</a></li><li class="paginate_button active"><a tabindex="0" data-dt-idx="1" aria-controls="project-progress" href="#">1</a></li><li id="project-progress_next" class="paginate_button next disabled"><a tabindex="0" data-dt-idx="2" aria-controls="project-progress" href="#">Next</a></li></ul></div></div></div></div>
                                    </div>
                    ...
                    <div class="row">
                                ...
                                <div class="tile-widget bg-blue">
                                    ...
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            </select><div title="" style="width: 304px;" class="chosen-container chosen-container-multi"><ul class="chosen-choices form-control"><li class="search-field"><input tabindex="3" value="Select recipients..." class="default" autocomplete="off" style="width: 125px;" type="text"></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div></div>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control underline-input" placeholder="Type subject..." type="text">
                                        </div>
                                    </form>
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile widget-chat">
                                ...
                                <!-- tile body -->
                                <div style="position: relative; overflow: hidden; width: auto; height: 100%;" class="slimScrollDiv"><div class="tile-body slim-scroll" style="max-height: 320px; overflow: hidden; width: auto; height: 100%;">
                                ...
                                </div><div style="background: rgb(0, 0, 0) none repeat scroll 0% 0%; width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 144.837px;" class="slimScrollBar"></div><div style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; opacity: 0.2; z-index: 90; right: 1px;" class="slimScrollRail"></div></div>
                                <!-- /tile body -->
                        ...
                        <div class="col-md-4">
                            ...
                            <section class="tile bg-greensea widget-appointments">
                                ...
                                <div class="tile-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-center">
                                            ...
                                            <div style="width: 100%;">
                                            <canvas style="width: 100px; height: 100px;" height="100" width="100" id="c1" class="CoolClock:minovateClock:50"></canvas>
                                            </div>
                                ...
                                <div class="tile-footer dvd dvd-top mt-20">
                                    ...
                                    <div style="opacity: 1; display: block;" class="owl-carousel owl-theme" id="appointments-carousel">
        ...
        <script>
            $(window).load(function(){
                ...
                Morris.Donut({
                    ...
                    data: [
                        {label: 'داخله عمومی', value: 25, color: '#00a3d8'},
                        {label: 'چشم', value: 20, color: '#2fbbe8'},
                        {label: 'نسایی ولادی', value: 15, color: '#72cae7'},
                        {label: 'گوش وگلو', value: 5, color: '#d9544f'},
                        {label: 'اورتوپیدی', value: 10, color: '#ffc100'},
                        {label: 'روان پزشکی', value: 25, color: '#1693A5'}
                    ],
                    resize: true
                });
                //*Initialize morris chart
